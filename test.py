from PySide6.QtWidgets import QTreeView, QFileSystemModel, QApplication, QMainWindow, QLabel, QWidget, QVBoxLayout, QListWidget
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        main_layout.addWidget(QLabel('Перетащите файл в окно ниже:'))
